...
class ControllerModuleLatest extends Controller {
	...
	public function index() {
		...
		$data['entry_id2'] = $this->language->get('entry_id2');
		$data['entry_id1'] = $this->language->get('entry_id1');
		...
		if (isset($this->request->post['cat1'])) {
			$data['cat1'] = $this->request->post['cat1'];
		} elseif (!empty($module_info)) {
			$data['cat1'] = $module_info['cat1'];
		} else {
			$data['cat1'] = '';
		}
		if (isset($this->request->post['catid1'])) {
			$data['catid1'] = $this->request->post['catid1'];
		} elseif (!empty($module_info)) {
			$data['catid1'] = $module_info['catid1'];
		} else {
			$data['catid1'] = '';
		}
		if (isset($this->request->post['cat2'])) {
			$data['cat2'] = $this->request->post['cat2'];
		} elseif (!empty($module_info)) {
			$data['cat2'] = $module_info['cat2'];
		} else {
			$data['cat2'] = '';
		}		
		if (isset($this->request->post['catid2'])) {
			$data['catid2'] = $this->request->post['catid2'];
		} elseif (!empty($module_info)) {
			$data['catid2'] = $module_info['catid2'];
		} else {
			$data['catid2'] = '';
		}
