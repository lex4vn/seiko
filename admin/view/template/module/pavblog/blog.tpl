			...
			<div class="pull-right">
				<?php
					if (empty($blog['keyword'])) {
				 		$linkBlog = HTTP_CATALOG.'index.php?route=pavblog/blog&blog_id='.$blog['blog_id']; 
				 	}else{
				 		$linkBlog = HTTP_CATALOG.$blog['keyword']; 
				 	}
				?>
				<?php if( $blog['blog_id'] || $blog['keyword'] ) { ?>
					<a  class="btn btn-success" href="<?php echo $linkBlog; ?>" target="_blank" title="Xem bài viết ngoài trang chủ">Xem bài viết</a>
				<?php } ?>
				...
				<?php if( $blog['blog_id'] ) { ?>
					<a id="action-delete" class="btn btn-danger" href="<?php echo $action_delete;?>"><?php echo $objlang->get("button_delete"); ?></a>	
				<?php } ?>
			</div>
					...
					<ul id="grouptabs" class="nav nav-tabs" role="tablist">
						<li>
							<a href="#tab-general" role="tab" data-toggle="tab">
								<?php echo $objlang->get("text_general"); ?></a>
						</li>
						<li>
							<a href="#tab-gallery" role="tab" data-toggle="tab">
								<?php echo $objlang->get("text_gallery"); ?></a>
						</li>
						<li>
							<a href="#tab-meta" role="tab" data-toggle="tab">
								<?php echo $objlang->get("text_meta"); ?></a>
						</li>
						<li>
							<a href="#tab-blog-related" role="tab" data-toggle="tab">
								<?php echo $objlang->get("text_blog_related"); ?></a>
						</li>
						<li>
							<a href="#tab-product-related" role="tab" data-toggle="tab">
								<?php echo $objlang->get("text_product_related"); ?></a>
						</li>
					</ul>
								...
								<div class="tab-pane" id="tab-language-<?php echo $language['language_id']; ?>">
									<table class="table">
										...
										<tr>
											...
											<td>
												<textarea id="pavblog_blog_description_title_lang<?php echo $language["language_id"];?>" class="form-control description150" type="text" name="pavblog_blog_description[<?php echo $language['language_id'];?>][description]"  rows="6" cols="10"><?php echo $pavblog_blog_descriptions[$language['language_id']]['description'];?></textarea>
											</td>
										</tr>
										</tr>
										<tr>
											...
											<td>
												<textarea id="pavblog_blog_description_des_lang<?php echo $language["language_id"];?>" class="form-control description350" type="text" name="pavblog_blog_description[<?php echo $language['language_id'];?>][content]"  rows="6" cols="10"><?php echo $pavblog_blog_descriptions[$language['language_id']]['content'];?></textarea>
											</td>
										</tr>
									</table>
								</div>
...
<script type="text/javascript">
	...
	$('.description150').summernote({ height: 150 });
	$('.description350').summernote({ height: 350 });
