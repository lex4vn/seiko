				...
				<div class="tab-content">
					<div id="tab-general" class="tab-pane">
						<table class="table">
							...
							<tr>
								<td class="col-sm-4">Thẻ Meta Title</td>
								<td class="col-sm-8"><input class="form-control"size="30" name="pavblog[title]" value="<?php echo $general_setting['title'];?>" /></td>
							</tr>
							<tr>
								<td class="col-sm-4">Thẻ Meta Description</td>
								<td class="col-sm-8">
                                <textarea name="pavblog[description]" rows="5" placeholder="<?php echo $general_setting['description'];?>" class="form-control"><?php echo $general_setting['description'];?></textarea>
                                </td>
							</tr>
							<tr>
								<td class="col-sm-4">Thẻ Meta Keywords</td>
								<td class="col-sm-8">
                                <textarea name="pavblog[keywords]" rows="5" placeholder="<?php echo $general_setting['keywords'];?>" class="form-control"><?php echo $general_setting['keywords'];?></textarea>
                                </td>
							</tr>                              
						</table>
					</div>
